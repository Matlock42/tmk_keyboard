 ...
 *  [    ]      (     )    &        ||       `     1     2     3    \
 * L2  insert super  del shift ctrl || alt space   fn    0     .    =
 */
#define FN_ARROW_LAYER   KEYMAP(SHIFT(KC_1), SHIFT(KC_2), KC_UP, SHIFT(KC_LBRC), SHIFT(KC_RBRC), \
                                  KC_HOME, KC_7, KC_8, KC_9, SHIFT(KC_8), \
                                SHIFT(KC_3), KC_LEFT, KC_DOWN, KC_RIGHT, SHIFT(KC_4), \
                                  KC_END KC_4, KC_5, KC_6, SHIFT(KC_EQUAL), \
                                KC_LBRC, KC_RBRC, SHIFT(KC_9), SHIFT(KC_0), SHIFT(KC_7), \
                                  KC_GRAVE, KC_1, KC_2, KC_3, KC_BSLS,    \
                                KC_FN1, SHIFT(KC_INS), KC_LGUI, KC_DELETE, KC_LSFT, KC_LCTL, \
                                  KC_LALT, KC_SPC, KC_FN0, KC_0, KC_KP_DOT, KC_EQUAL)

/*
 * insert home   up  end   pgup       ||      up     F7    F8    F9   F10
 *  del   left  down right pgdn       ||     down    F4    F5    F6   F11
 * mouse volup             reset      ||             F1    F2    F3   F12
 *       voldn  super bksp shift ctrl || alt space   L0  prtsc scroll pause
 */
#define LAYER_TWO KEYMAP(KC_INS, KC_HOME, KC_UP, KC_END, KC_PGUP, \
                         ...
                         KC_NO, KC__VOLDOWN, KC_LGUI, KC_BSPC, KC_LSFT, KC_LCTL, \
